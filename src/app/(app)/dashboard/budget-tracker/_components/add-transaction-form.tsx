...
import { addTransaction } from '@/lib/budget-tracker/actions';
import { NOTE_MAX } from '@/lib/budget-tracker/types';
...
export function AddTransactionForm({ categoryId }: { categoryId: string }) {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      const res = await addTransaction(categoryId, form);
      if (!res.ok) {
      ...
      <div className="grid gap-3 md:grid-cols-12">
        ...
        <div className="md:col-span-6">
          ...
          <input
            ...
            placeholder="Trader Joe's, lunch with Sam..."
            maxLength={NOTE_MAX}
            className="form-input"
            disabled={isPending}
          />
